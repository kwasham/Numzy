export const navColorStyles = {
	dark: {
		glass: {
			"--SideNav-background":
				"linear-gradient(180deg, rgba(255,255,255,0.02) 0%, rgba(255,255,255,0.07) 52%, rgba(255,255,255,0) 100%)",
			"--SideNav-color": "var(--mui-palette-common-white)",
			"--SideNav-border": "none",
			"--SideNav-backdropFilter": "blur(8px)",
			"--SideNav-shadow": "14px 0 48px rgba(0,0,0,0.15)",
			"--SideNav-radius": "50px",
	...
	light: {
		glass: {
			"--SideNav-background":
				"linear-gradient(180deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.12) 52%, rgba(255,255,255,0) 100%)",
			"--SideNav-color": "var(--mui-palette-common-white)",
			"--SideNav-border": "none",
			"--SideNav-backdropFilter": "blur(8px)",
			"--SideNav-shadow": "14px 0 48px rgba(0,0,0,0.15)",
